...
DATABASES = {
    "default": {
        ...
        # Add username prefix only if DB_HOST contains 'pythonanywhere'
        "NAME": (
            os.getenv("DB_USER", "Admin") + "$" + os.getenv("DB_NAME", "myportfolio")
            if "pythonanywhere" in os.getenv("DB_HOST", "")
            else os.getenv("DB_NAME", "myportfolio")
        ),
